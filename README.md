...
## Migrating from `@thallesp/nestjs-better-auth`

| There                                | Here                                                                    |
| ------------------------------------ | ----------------------------------------------------------------------- |
| `AuthModule.forRoot(auth, options?)` | `BetterAuthModule.forRoot({ auth, ...options })`                        |
| `bodyParser: false` required         | Not needed (works if kept)                                              |
| `AuthService`                        | `BetterAuthService` (`.api`, `.instance` unchanged)                     |
